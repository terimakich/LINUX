...
async def start_pm(client, message: Message, _):
    ...
    start_text = (
    f"<b>ʜᴇʟʟᴏ,</b> {message.from_user.mention} {heart_markdown}.<br>"
    f"ʏᴏᴜ’ʀᴇ ɴᴏᴡ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ <b>{app.mention} 💗</b><br>"
    "⟶ ᴀ sʟᴇᴇᴋ ᴍᴜsɪᴄ ʙᴏᴛ ᴄʀᴀғᴛᴇᴅ ғᴏʀ sᴛʀᴇᴀᴍɪɴɢ ᴡɪᴛʜ sᴛʏʟᴇ, sᴘᴇᴇᴅ & ᴘᴏᴡᴇʀ.<br>"
    "<b>ᴘʟᴀᴛғᴏʀᴍs :</b> ʏᴏᴜᴛᴜʙᴇ • sᴘᴏᴛɪғʏ • ᴀᴘᴘʟᴇ • sᴏᴜɴᴅᴄʟᴏᴜᴅ • ʀᴇssᴏ<br>"
